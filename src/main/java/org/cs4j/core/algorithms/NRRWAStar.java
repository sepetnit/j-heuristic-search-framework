 ...
 */
public class NRRWAStar implements SearchAlgorithm {
    ...
    static
    {
        ...
        NRRWAStar.WRAStarPossibleParameters.put("weight", Double.class);
        NRRWAStar.WRAStarPossibleParameters.put("w-admissibility-deviation-percentage", String.class);
        NRRWAStar.WRAStarPossibleParameters.put("iteration-to-start-reopening", Integer.class);
        NRRWAStar.WRAStarPossibleParameters.put("bpmx", Boolean.class);
        NRRWAStar.WRAStarPossibleParameters.put("restart-closed-list", Boolean.class);
    }
    ...
    public Map<String, Class> getPossibleParameters() {
        return NRRWAStar.WRAStarPossibleParameters;
    }
    ...
    */
    ...
    protected final class Node extends SearchQueueElementImpl implements BucketHeapElement {
        ...
        private Node(State state, Node parent, State parentState, Operator op, Operator pop) {
            ...
            // Parent node
            this.parent = parent;
            this.packed = NRRWAStar.this.domain.pack(state);
            this.pop = pop;
            this.op = op;
        }
         ...
         */
        public double getWf() {
            return this.g + (NRRWAStar.this.weight * this.h);
        }
